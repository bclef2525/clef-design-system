...
import {
  ...
  nameSpaceClassNames,
  withReset
} from "./chunk-ONKBV7BT.js";
import {
  ActionBar
} from "./chunk-KSITF6GA.js";
import "./chunk-LUQLWONA.js";
import {
  ThemeProvider,
  convert,
  ensure,
...
import {
  ...
  require_toKey,
  str
} from "./chunk-5GF23CSA.js";
import {
  require_Symbol,
  require_isObject,
  require_isObjectLike,
  require_root
} from "./chunk-JIZUWBDO.js";
import {
  P
} from "./chunk-KZWN5ARD.js";
import {
  esm_default
...
import {
  renderElement,
  unmountElement
} from "./chunk-MHG2DCFB.js";
import {
  require_global
} from "./chunk-KAIUKZMP.js";
import "./chunk-FAPRAKDF.js";
import "./chunk-QG2QCI7O.js";
import {
  require_react
...
// ../../node_modules/.pnpm/@storybook+addon-docs@7.6.20_@types+react-dom@18.3.6_@types+react@18.3.20__@types+react_3d7e246142923a8cd9e9acd3a2e4e19b/node_modules/@storybook/addon-docs/dist/chunk-HLWAVYOI.mjs
var import_react2 = __toESM(require_react(), 1);

// ../../node_modules/.pnpm/@storybook+blocks@7.6.20_@types+react-dom@18.3.6_@types+react@18.3.20__@types+react@18._a34ba16f47ac3fb2d20230aba61f6b41/node_modules/@storybook/blocks/dist/index.mjs
...
// ../../node_modules/.pnpm/tocbot@4.36.2/node_modules/tocbot/src/js/build-html.js
...
// ../../node_modules/.pnpm/tocbot@4.36.2/node_modules/tocbot/src/js/default-options.js
...
// ../../node_modules/.pnpm/tocbot@4.36.2/node_modules/tocbot/src/js/parse-content.js
...
// ../../node_modules/.pnpm/tocbot@4.36.2/node_modules/tocbot/src/js/scroll-smooth/index.js
...
// ../../node_modules/.pnpm/tocbot@4.36.2/node_modules/tocbot/src/js/update-toc-scroll.js
...
// ../../node_modules/.pnpm/tocbot@4.36.2/node_modules/tocbot/src/js/index-esm.js
var _options = {};
var _buildHtml;
var _parseContent;
var _headingsArray;
...
function init(customOptions) {
  ...
  _scrollListener = scrollHandler((e2) => {
    ...
    const isTop = ((_b = (_a = e2 == null ? void 0 : e2.target) == null ? void 0 : _a.scrollingElement) == null ? void 0 : _b.scrollTop) === 0;
    if (e2 && (e2.eventPhase === 0 || e2.currentTarget === null) || isTop) {
      _buildHtml.updateToc(_headingsArray);
      (_c = _options.scrollEndCallback) == null ? void 0 : _c.call(_options, e2);
    }
...
function debounce(func, wait) {
  ...
  return (...args2) => {
    ...
    timeout = setTimeout(() => func.apply(this, args2), wait);
  };
}
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = import_global.global, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./dist-E36E3KQ5.js");
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-6VNJS4EI-5HE32O4L.js"));
...
var DocsRenderer = class {
  constructor() {
    this.render = async (context, docsParameter, element) => {
      ...
      return new Promise((resolve, reject) => {
        import("./react-HY6XN2GH.js").then(({ MDXProvider }) => renderElement(import_react2.default.createElement(ErrorBoundary, { showException: reject, key: Math.random() }, import_react2.default.createElement(MDXProvider, { components }, import_react2.default.createElement(TDocs, { context, docsParameter }))), element)).then(() => resolve());
      });
...
telejson/dist/index.mjs:
   ...
   *)
*/
//# sourceMappingURL=DocsRenderer-NNNQARDV-2BAS3VSM.js.map
